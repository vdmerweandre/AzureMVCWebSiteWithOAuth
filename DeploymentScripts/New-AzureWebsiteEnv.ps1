...
$sqlMemberDatabaseName = "contactdb"
...
$storage = & "$scriptPath\New-AzureStorageAccount.ps1" -Name $storageAccountName -Location $Location
...
$sql = & "$scriptPath\New-AzureSqlDB.ps1" `
